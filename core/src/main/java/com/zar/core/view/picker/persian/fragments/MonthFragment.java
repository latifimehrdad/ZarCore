package com.zar.core.view.picker.persian.fragments;
...
import com.zar.core.view.picker.persian.adapters.MonthAdapter;
...
public class MonthFragment extends Fragment implements View.OnClickListener {
    ...
    private void initPager(final int year, int chosenMonth) {
        mAdapter = new MPagerAdapter(year);
    ...
    private class MPagerAdapter extends PagerAdapter implements View.OnClickListener {
        private int mCurrentYear;
        private RecyclerView.RecycledViewPool viewPool = new RecyclerView.RecycledViewPool();

        MPagerAdapter(int year) {
            mCurrentYear = year;
        }
