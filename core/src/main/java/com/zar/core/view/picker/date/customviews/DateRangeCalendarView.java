package com.zar.core.view.picker.date.customviews;
...
import com.zar.core.view.picker.date.dialog.TimePickerDialog;
import com.zar.core.view.picker.date.models.DayContainer;
...
public class DateRangeCalendarView extends LinearLayout {
    ...
    private int headerBackgroundColor, headerTextColor, weekColor, rangeStripColor, selectedDateCircleColor, selectedDateColor, defaultDateColor, disableDateColor, rangeDateColor, holidayColor, todayColor;
...
//        textSizeDate = getResources().getDimension(R.dimen.text_size_date);
        ...
        headerTextColor = ContextCompat.getColor(mContext, R.color.white);
    ...
    public void setAttributes() {
        ...
        try {
            ...
            headerTextColor = ta.getColor(R.styleable.DateRangeCalendarView_title_color, headerTextColor);
...
//        }
    ...
    public void setHeaderTextColor(int headerTextColor) {
        this.headerTextColor = headerTextColor != 0 ? headerTextColor : this.headerTextColor;
    }
